...
public class MainActivityTest {
    private static final int EXPECTED_CUSTOMERS_COUNT = 14;
    ...
    public void checkCustomers() {
        ...
        onView(withId(R.id.rclr_customers)).check(new RecyclerViewItemsCountAssertion(EXPECTED_CUSTOMERS_COUNT));
        // scroll to last item
        onView(withId(R.id.rclr_customers)).perform(scrollToPosition(EXPECTED_CUSTOMERS_COUNT - 1));
